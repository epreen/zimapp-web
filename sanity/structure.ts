        ...
        S.list()
          ...
          .items([
            S.listItem()
              ...
              .schemaType('businessApplication')
              .child(
                S.documentTypeList('businessApplication')
                  .title('All Applications')
                  .defaultOrdering([
            ...
            S.listItem()
              ...
              .child(
                S.documentTypeList('businessApplication')
                  .title('Pending Review')
                  .filter('_type == "businessApplication" && status == "pending"')
                  .defaultOrdering([
                    { field: 'appliedAt', direction: 'desc' },
                  ])
              ),
            ...
            S.listItem()
              ...
              .child(
                S.documentTypeList('businessApplication')
                  .title('Under Review')
                  .filter('_type == "businessApplication" && status == "reviewing"')
                  .defaultOrdering([
                    { field: 'appliedAt', direction: 'desc' },
                  ])
              ),
            ...
            S.listItem()
              ...
              .child(
                S.documentTypeList('businessApplication')
                  .title('Approved')
                  .filter('_type == "businessApplication" && status == "approved"')
              ),
            ...
            S.listItem()
              ...
              .child(
                S.documentTypeList('businessApplication')
                  .title('Rejected')
                  .filter('_type == "businessApplication" && status == "rejected"')
              ),
          ])
      ),
