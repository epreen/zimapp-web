...
import { CheckoutButton } from "@/components/ui/buttons/checkout-button";
    ...
    return (
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          <ShoppingBag className="mx-auto h-16 w-16 text-foreground/40" />
          <h1 className="mt-6 text-xl font-bold text-foreground/80">
            Your cart is empty
          </h1>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <Link
          href="/"
          className="inline-flex items-center text-sm text-foreground/40"
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          Continue Shopping
        </Link>
        <h1 className="mt-4 text-2xl font-bold text-foreground/80">
          Checkout
        </h1>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3">
          <div className="rounded-lg border border-foreground/10">
            ...
            {hasStockIssues && !isLoading && (
              <div className="mx-6 mt-4 flex items-center gap-2 rounded-lg border border-amber-600 bg-amber-600/10 px-4 py-3 text-sm text-amber-600/80">
                ...
                return (
                  <div
                    ...
                    className={`flex gap-4 px-6 py-4 ${
                      hasIssue ? "bg-red-600/10" : ""
                    }`}
                  >
                    {/* Image */}
                    <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-md bg-foreground/10">
                      {item.image ? (
                        <Image
                          src={item.image}
                          alt={item.name}
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-24 rounded-lg border border-foreground/10 p-6">
