...
import {
  ...
  MessageBubble,
  ToolCallUI,
} from "@/components/ui/layout/chat";
...
export function ChatSheet() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed top-0 right-0 z-50 flex h-full w-full flex-col border-l border-foreground/20 overscroll-contain sm:w-[448px] animate-in slide-in-from-right duration-300 bg-background">
        <div className='bg-primary text-background text-right py-1.5 px-4'>
        <span className='font-medium text-xs'>Shopping Assistant</span>
        </div>
        {/* Header */}
        <header className="shrink-0 border-b border-foreground/20">
        ...
        {/* Input */}
        <div className="border-t border-foreground/20 px-4 py-4">
