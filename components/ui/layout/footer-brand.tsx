...
export const FooterBrand = () => (
    ...
    >
        <Link href={'/home'} className="text-4xl font-semibold text-foreground">
            <span className="text-primary font-light">zim</span>app<span className="text-primary text-5xl leading-0">.</span>
        </Link>
