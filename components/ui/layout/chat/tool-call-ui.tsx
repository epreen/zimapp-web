...
import type { ToolCallPart } from "@/components/ui/layout/chat/types";
import type { SearchProductsResult } from "@/lib/ai/types";
import type { GetMyOrdersResult } from "@/lib/ai/tools/get-my-orders";
import { getToolDisplayName } from "@/components/ui/layout/chat/utils";
import { ProductCardWidget } from "@/components/ui/widgets/product-card-widget";
import { OrderCardWidget } from "@/components/ui/widgets/order-card-widget";
