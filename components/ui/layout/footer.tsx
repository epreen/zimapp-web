...
// import { FooterBrand } from "@/components/ui/layout/footer-brand";
...
export default function Footer() {
    ...
    return (
        <footer
            ref={footerRef}
            className="bg-white/20 dark:bg-black/20 py-6 border-t border-primary/20"
        >
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
                © {new Date().getFullYear()} <span className="font-bold text-foreground uppercase"><span className="text-primary">zim</span>app</span> - All rights reserved.
            </motion.div>
        </footer>
    );
}