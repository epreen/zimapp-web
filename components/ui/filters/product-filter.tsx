...
export function ProductFilters({ categories }: ProductFiltersProps) {
  ...
  const FilterLabel = ({
    ...
    <div className="mb-2 flex items-center justify-between">
      ...
      >
        {children}
        {isActive && (
          <Badge className="ml-2 h-5 bg-amber-600 px-1.5 text-xs text-white">
            Active
          </Badge>
        )}
      </span>
  ...
  return (
    <div className="space-y-6 rounded-lg border border-foreground/10 p-6">
      {/* Clear Filters - Show at top when active */}
      {hasActiveFilters && (
        <div className="rounded-lg border-2 border-amber-600/20 bg-amber-600/10 p-3">
          <div className="mb-2 flex items-center justify-between">
      ...
      <div>
        ...
        <form onSubmit={handleSearchSubmit} className="flex gap-2">
          <Input
            ...
            className={`flex-1 ${
              isSearchActive
                ? "border-amber-600/40 ring-1 ring-amber-600/80"
                : ""
            }`}
          />
      ...
      <div>
        ...
        <Slider
          ...
          className={`mt-4 ${isPriceActive ? "**:[[role=slider]]:border-amber-600 **:[[role=slider]]:ring-amber-600" : ""}`}
        />
      </div>
      ...
      <div>
        <label className="flex cursor-pointer items-center gap-3">
          <input
            ...
            className="h-5 w-5 rounded border-foreground/20 text-amber-600 focus:ring-amber-600/60 dark:border-foreground/60"
          />
          <span
