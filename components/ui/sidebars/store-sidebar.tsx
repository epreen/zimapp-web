            ...
            <div className="max-sm:mt-6">
                {
                    sidebarLinks.map((link, index) => (
                        <Link key={index} href={link.href} className={`relative flex items-center gap-3 text-foreground/60 hover:bg-primary/10 dark:hover:bg-secondary/3 p-2.5 transition ${pathname === link.href && 'bg-primary/10 dark:bg-secondary/10 text-primary dark:text-secondary'}`}>
