...
import { StockInput } from "@/components/ui/inputs/stock-input";
import { PriceInput } from "@/components/ui/inputs/price-input";
import { FeaturedToggle } from "@/components/ui/toggles/featured-toggle";
import { PublishButton, RevertButton } from "@/components/ui/buttons/publish-button";
  ...
  return (
    <TableRow className="group">
      ...
      <TableCell className="py-3 sm:py-4">
        <Link
          href={`/studio/store/${handle.documentId}`}
