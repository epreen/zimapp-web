...
export const contactConfig = {
  company: {
    name: process.env.NEXT_PUBLIC_COMPANY_NAME || "zimapp",
    email: process.env.NEXT_PUBLIC_COMPANY_EMAIL || "support@zimapp.com",
  ...
  emails: {
    support: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@zimapp.com",
    sales: process.env.NEXT_PUBLIC_SALES_EMAIL || "sales@gozimapp.com",
  },
  responseTime: {
    standard:
  ...
  legal: {
    copyright:
      ...
      "© 2024 zimapp. All rights reserved.",
