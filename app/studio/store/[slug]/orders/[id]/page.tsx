      ...
      <div className="grid gap-6 lg:grid-cols-5 lg:gap-8">
        ...
        <div className="space-y-6 lg:col-span-3">
          <div className="rounded-xl border border-foreground/10">
            <div className="border-b border-foreground/10 px-4 py-3 sm:px-6 sm:py-4">
            ...
            <div className="divide-y divide-foreground/10">
              {data.items?.map((item) => (
                ...
                >
                  {/* Image */}
                  <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-md bg-foreground/10 sm:h-20 sm:w-20">
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-xl border border-foreground/10 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <Edit2 className="h-4 w-4 text-foreground/40" />
            </div>
            <div className="mt-4">
              <Suspense
                fallback={
          ...
          <div className="rounded-xl border border-foreground/10 p-4 sm:p-6">
            ...
            <Link
              ...
              target="_blank"
              className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-foreground hover:text-foreground/60"
            >
              Open in Studio
              <ExternalLink className="h-3.5 w-3.5" />
            </Link>
...
export default function OrderDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <Link
        href="/admin/orders"
        className="inline-flex items-center text-sm text-foreground/60 hover:text-foreground/80"
      >
