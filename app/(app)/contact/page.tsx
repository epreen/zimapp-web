...
const ContactPage = () => {
  ...
  return (
    <div className="bg-linear-to-b from-background to-secondary/10 min-h-screen">

      <div className="max-w-7xl px-4 mx-auto py-6 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          >
            <div className="bg-background p-6 lg:p-8 border border-foreground/10">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {info.href ? (
                        <a
                          href={info.href}
                          className="text-foreground/60 text-sm mb-1 hover:text-primary/80 transition-colors duration-200 flex items-center gap-1 group"
                          target={
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 focus:border-primary/40 focus:ring-primary/20 border-foreground/10"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    required
                    className="border-foreground/10 h-12 focus:border-primary/40 focus:ring-primary/20"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    rows={6}
                    required
                    className="border-foreground/10 resize-none focus:border-primary/40 focus:ring-primary/20"
                  />
                </div>
                ...
                <AnimatePresence>
                  {error && (
                    <motion.div
                      ...
                      className="flex items-center gap-2 p-4 bg-red-600/10 border border-red-600/20 rounded-lg"
                    >
                      <AlertCircle className="w-5 h-5 text-red-600 shrink-0" />
                      <p className="text-sm text-red-600/60">{error}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto bg-primary hover:bg-primary text-background h-12 px-8 font-semibold rounded-lg transition-all duration-300 hover transform hover:scale-[1.02] disabled:transform-none"
                >
                  {loading ? (
                    <>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-background p-6 rounded-lg border border-foreground/10"
              >
                <h3 className="font-semibold text-primary mb-2">
                  {faq.q}
                </h3>
                <p className="text-foreground text-sm">{faq.a}</p>
              </div>
            ))}
          </div>
        </motion.div>
      ...
      <AnimatePresence>
        {success && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 flex items-center justify-center bg-foreground/60 z-50 p-4"
          ...
          >
            <motion.div
              ...
              className="bg-background p-8 max-w-md w-full mx-4"
            ...
            >
              <div className="text-center">
                ...
                <Button
                  onClick={() => setSuccess(false)}
                  className="w-full bg-primary hover:bg-primary text-background h-12 font-semibold rounded-lg transition-all duration-300"
                >
                  Close
                </Button>
              </div>
