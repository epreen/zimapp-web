...
| minPrice | number | Minimum price in MWK (0 = no minimum) |
| maxPrice | number | Maximum price in MWK (0 = no maximum) |
...
**For "leather sofas under MWK1000":**
\`\`\`json
{
  "query": "",
  "category": "sofas",
...
- name, price, priceFormatted (e.g., "MWK599.00")
...
**[Product Name](/products/slug)** - MWK599.00
- Material: Oak wood
...
- Always include prices in MWK (MWK)
